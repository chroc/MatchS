...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { additional_info: @field.additional_info, address: @field.address, name: @field.name, rating: @field.rating } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { additional_info: @field.additional_info, address: @field.address, name: @field.name, rating: @field.rating } }
